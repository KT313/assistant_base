    ...
    if test_mode:
        for entry in model:
            if not multi_turn:
                print("\n\n\n\n\n\n\n")
                infer({
                    'chat': [{'role': 'System', 'content': 'Hello, I am the system.'}, {'role': 'User', 'content': 'Alice has 4 brothers and she also has 2 sisters. How many sisters does Alice’s brother have?'}], 
                    'model': entry, 
